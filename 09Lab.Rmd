...
Randomly select 75 samples from the iris data set. Use “set.seed” so we are all working with the same training set:
...
First, let’s set the cp for the optimal tree size. This extracts the cp value according to the 1-SE rule. *Note you will have to change the row, column designations for other examples*. 
